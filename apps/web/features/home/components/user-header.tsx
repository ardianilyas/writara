      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <span className="text-lg font-bold tracking-tight text-slate-900">
            Writara <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-700">AI</span>
          </span>
        </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-100 border border-slate-200 text-xs">
                ...
                <div className="text-left">
                  <p className="font-semibold text-slate-900 leading-none">{user.name || 'User'}</p>
